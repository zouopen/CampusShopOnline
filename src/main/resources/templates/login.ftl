        ...
        <div class="login">
            ...
            <form action="/postLogin" class="login__form" method="post">
                ...
                <div class="login__row">
                    ...
                    <#--验证码-->
                    <input type="text" name="captcha" class="login__VC " placeholder="验证码" />
                    <img alt="验证码" src="/Captcha.jpg"   class="VC_img" id="captcha_img" onclick="refreshCaptcha()"/>
                </div>
                <button type="submit" class="login__submit">登 录</button>
                <p class="login__signup">还没有账号? &nbsp;<a href="#" target="_blank">申请加入</a></p>
            </form>
        </div>
        <div class="app">
            <div class="app__bot">
                ...
                <form class="app__meetings reg__form">
                    <div class="app__meeting">
                        <div class="reg__enter">
                            <a href="#" style="text-align: center">加入我们,请提供学生证明资料发送邮箱到hack7458@outlook.com</a>
                        </div>
                </form>
            </div>
