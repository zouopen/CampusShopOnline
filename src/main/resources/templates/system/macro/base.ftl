        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a target="navTab" href="user/list"><i class="fa fa-inbox"></i>
                            <span>用户管理</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i>
                    <span>电商管理</span> <span class="pull-right-container"><i
                ...
                <ul class="treeview-menu">
                    <li>
                        <a target="navTab"
                           href="/shop/list">
                            <i class="fa fa-inbox"></i> <span>店铺管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab"
                           href="/shopCategory/list">
                            <i class="fa fa-inbox"></i> <span>类目管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab"
                           href="/examine/list">
                            <i class="fa fa-inbox"></i> <span>店铺审核</span>
                        </a>
                    </li>
                </ul>
            </li>
...
<header class="main-header">
    <a href="index2.html" class="logo">
        <span class="logo-mini"><b>茂名职业电商管理平台</b></span>
        <span class="logo-lg"><b>茂名职业电商管理平台</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="adminlte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"> <span
                            class="hidden-xs">${shiroUserDTO.username}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            ...
                            <p>
                                <small>${shiroUserDTO.createTime!"无"}  加入</small>
                            </p>
                        </li>
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/user/resetPwd?id=${shiroUserDTO.id}" target="modal" modal="lg"  class="btn btn-default btn-flat">密码修改</a>
                            </div>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2025 <a href="https://www.elliopeng.cn">EvilSay</a>.
...
<link rel="shortcut icon" type="image/x-icon" href="css/13.png">
<!-- Bootstrap 3.3.6 -->
